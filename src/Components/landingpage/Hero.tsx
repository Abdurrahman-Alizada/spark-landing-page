          ...
          <div className="flex items-center flex-col justify-center px-2  md:w-1/2">
            <a href="/" className="touch-manipulation text-[#21262e] no-underline">
              {/* <Image
                ...
                width={200} 
                height={20}
                className="w-[250px] md:w-[300px] h-40 bg-transparent"
              /> */}
             
            </a>

            <h1 className="text-white text-[24px] md:text-[34px] pl-8  pb-2 font-bold tracking-normal leading-[32px] md:leading-[42px] mt-10 md:mt-0 mb-4 mx-4 md:mx-10">
