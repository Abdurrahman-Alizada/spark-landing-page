      ...
      <div className="container mx-auto flex justify-between items-center  px-4 md:px-6">
        <div className="flex items-center fill-inherit  ">
          <img
            ...
            alt="Sparks Logo"
            className="h-16  w-15 object-contain  " // Consistent height, width adjusts automatically 
          />
          <span className=" text-white text-2xl sm:text-4xl px-2 font-serif lg:text-3xl tracking-widest">
            SPARKS
          </span>
        </div>
